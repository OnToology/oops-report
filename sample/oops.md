...
<img src="critical.png" height="100px">

<img src="critical.png" height="100px"> It is crucial to correct the pitfall. Otherwise, it could affect the ontology consistency, reasoning, applicability, etc.

<img src="important.png" height="60px"> Though not critical for ontology function, it is important to correct this type of pitfall.

<img src="minor.png" height="30px"> It is not really a problem, but by correcting it we will make the ontology nicer.
